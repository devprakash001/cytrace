  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        <p className="mb-4">Last updated: June 13, 2024</p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">1. Agreement to Terms</h2>
        <p>
          By accessing or using the services provided by Cytrace ("we," "our," or "us"), you agree to be bound by these
          Terms of Service. If you do not agree to these terms, please do not use our services.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">2. Description of Services</h2>
        <p>
          Cytrace provides cybersecurity services including but not limited to penetration testing, compliance
          consulting, security training, and related professional services as described on our website.
        </p>
        ...
        <p>
          ...
          icons, images, audio clips, digital downloads, and software, are owned by Cytrace or our licensors and are
          protected by copyright, trademark, and other intellectual property laws.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">5. Limitation of Liability</h2>
        <p>
          To the maximum extent permitted by law, Cytrace shall not be liable for any indirect, incidental, special,
        ...
        <p>
          You agree to defend, indemnify, and hold harmless Cytrace and our officers, directors, employees, and agents
        ...
        <p>
          ...
          the updated Terms on our website. Your continued use of our services after any such changes constitutes your
        ...
        <p className="mt-2">
          Email: legal@cytrace.com
          <br />
          Address: 123 Security Blvd, Suite 101, Cyber City, CS 90210
        </p>
      </div>
    </div>
  )
