    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            <strong>Persistent cookies:</strong> These cookies remain on your device until they expire or you delete
            them.
          </li>
          <li>
          ...
          <li>
            <strong>Third-party cookies:</strong> These cookies are set by third parties, such as analytics providers
        ...
        <p>
          ...
          ability of websites to set cookies, you may worsen your overall user experience, as it will no longer be
          personalized to you.
        </p>
        <p className="mt-2">
        ...
        <p>
          ...
          Policy on this page. You are advised to review this Cookie Policy periodically for any changes.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">6. Contact Us</h2>
        <p>If you have questions or comments about our Cookie Policy, please contact us at:</p>
        <p className="mt-2">
          Email: privacy@cytrace.com
          <br />
